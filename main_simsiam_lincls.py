...
writer = SummaryWriter('runs/lcsimsiam_reco')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    f = open('./runs/acc_simsiamlc.txt', 'a+')
    f.write('lc ddp acc1: {}\n'.format(best_acc1))
    f.write('lc ddp acc5: {}\n'.format(best_acc5))
    f.close()
...
def save_checkpoint(state, is_best, filename='checkpoint_simsiam.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, 'model_best_simsiam.pth.tar')
